...
@section('content')
      ...
      <div class="home-slideshow slick-arrow-dots">
            ...
            <div class="slideshow-wrap">
               <picture>
                  <source media="(max-width:767px)"
                     srcset="{{ asset('frontend') }}/assets/images/slideshow/demo1-banner1-mbl.jpg" width="1150"
                     height="800">
                  <img class="blur-up lazyload" src="{{ asset('frontend') }}/assets/images/slideshow/demo1-banner1.jpg"
         ...
         <div class="slide">
            <div class="slideshow-wrap">
               <picture>
                  <source media="(max-width:767px)"
                     srcset="{{ asset('frontend') }}/assets/images/slideshow/demo1-banner2-mbl.jpg" width="1150"
                     height="800">
                  <img class="blur-up lazyload" src="{{ asset('frontend') }}/assets/images/slideshow/demo1-banner2.jpg"
                     alt="slideshow" title="" width="1920" height="795" />
               </picture>
               <div class="container">
         ...
         <div class="slide">
            <div class="slideshow-wrap">
               <picture>
                  <source media="(max-width:767px)"
                     srcset="{{ asset('frontend') }}/assets/images/slideshow/demo1-banner3-mbl.jpg" width="1150"
                     height="800">
                  <img class="blur-up lazyload" src="{{ asset('frontend') }}/assets/images/slideshow/demo1-banner3.jpg"
                     alt="slideshow" title="" width="1920" height="795" />
               </picture>
               <div class="container">
                  <div class="slideshow-content slideshow-overlay middle-right">
                     ...
                     <a href="shop-left-sidebar.html" class="zoom-scal">
                        <div class="img">
                           <img class="blur-up lazyload"
                              ...
                              src="{{ asset('frontend') }}/assets/images/collection/demo1-ct-img1.jpg" alt="Women Wear"
                              title="Women Wear" width="645" height="723" />
                        </div>
                     ...
                     <a href="shop-left-sidebar.html" class="zoom-scal">
                        <div class="img">
                           <img class="blur-up lazyload"
                              ...
                              src="{{ asset('frontend') }}/assets/images/collection/demo1-ct-img2.jpg" alt="Mens Wear"
                              title="Mens Wear" width="645" height="344" />
                        </div>
                     ...
                     <a href="shop-left-sidebar.html" class="zoom-scal">
                        <div class="img">
                           <img class="blur-up lazyload"
                              ...
                              src="{{ asset('frontend') }}/assets/images/collection/demo1-ct-img3.jpg" alt="Kids Wear"
                              title="Kids Wear" width="645" height="349" />
                        </div>
                        <div class="details middle-right">
                           <div class="inner">
      ...
      <div class="container">
         ...
         <div class="collection-slider-5items gp15 arwOut5 hov-arrow">
            <div class="category-item zoomscal-hov">
               <a href="shop-left-sidebar.html" class="category-link clr-none">
                  <div class="zoom-scal zoom-scal-nopb rounded-3"><img class="blur-up lazyload"
                        data-src="{{ asset('frontend') }}/assets/images/collection/sub-collection1.jpg"
                        src="{{ asset('frontend') }}/assets/images/collection/sub-collection1.jpg" alt="Men's Jakets"
            ...
            <div class="category-item zoomscal-hov">
               <a href="shop-left-sidebar.html" class="category-link clr-none">
                  <div class="zoom-scal zoom-scal-nopb rounded-3"><img class="blur-up lazyload"
                        data-src="{{ asset('frontend') }}/assets/images/collection/sub-collection3.jpg"
                        src="{{ asset('frontend') }}/assets/images/collection/sub-collection3.jpg" alt="Tops"
            ...
            <div class="category-item zoomscal-hov">
               <a href="shop-left-sidebar.html" class="category-link clr-none">
                  <div class="zoom-scal zoom-scal-nopb rounded-3"><img class="blur-up lazyload"
                        data-src="{{ asset('frontend') }}/assets/images/collection/sub-collection5.jpg"
                        src="{{ asset('frontend') }}/assets/images/collection/sub-collection5.jpg" alt="T-Shirts"
            ...
            <div class="category-item zoomscal-hov">
               <a href="shop-left-sidebar.html" class="category-link clr-none">
                  <div class="zoom-scal zoom-scal-nopb rounded-3"><img class="blur-up lazyload"
                        data-src="{{ asset('frontend') }}/assets/images/collection/sub-collection6.jpg"
                        src="{{ asset('frontend') }}/assets/images/collection/sub-collection6.jpg" alt="Shoes"
            ...
            <div class="category-item zoomscal-hov">
               <a href="shop-left-sidebar.html" class="category-link clr-none">
                  <div class="zoom-scal zoom-scal-nopb rounded-3"><img class="blur-up lazyload"
                        data-src="{{ asset('frontend') }}/assets/images/collection/sub-collection9.jpg"
                        src="{{ asset('frontend') }}/assets/images/collection/sub-collection9.jpg" alt="Shorts"
            ...
            <div class="category-item zoomscal-hov">
               <a href="shop-left-sidebar.html" class="category-link clr-none">
                  <div class="zoom-scal zoom-scal-nopb rounded-3"><img class="blur-up lazyload"
                        data-src="{{ asset('frontend') }}/assets/images/collection/sub-collection2.jpg"
                        src="{{ asset('frontend') }}/assets/images/collection/sub-collection2.jpg" alt="Sunglasses"
            ...
            <div class="category-item zoomscal-hov">
               <a href="shop-left-sidebar.html" class="category-link clr-none">
                  <div class="zoom-scal zoom-scal-nopb rounded-3"><img class="blur-up lazyload"
                        data-src="{{ asset('frontend') }}/assets/images/collection/sub-collection4.jpg"
                        src="{{ asset('frontend') }}/assets/images/collection/sub-collection4.jpg" alt="Girls Top"
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3"><img
                                       ...
                                       src="{{ asset('frontend') }}/assets/images/products/product1.jpg" alt="Product"
                              ...
                              <div class="product-details">
                                 ...
                                 <ul class="variants-clr swatches">
                                    <li class="swatch medium radius"><span class="swatchLbl" data-bs-toggle="tooltip"
                                          data-bs-placement="top" title="Navy"><img
                                             src="{{ asset('frontend') }}/assets/images/products/product1.jpg"
                                             alt="product" width="625" height="808" /></span></li>
                                    <li class="swatch medium radius"><span class="swatchLbl" data-bs-toggle="tooltip"
                                          data-bs-placement="top" title="Green"><img
                                             src="{{ asset('frontend') }}/assets/images/products/product1-1.jpg"
                                             alt="product" width="625" height="808" /></span></li>
                                    <li class="swatch medium radius"><span class="swatchLbl" data-bs-toggle="tooltip"
                                          data-bs-placement="top" title="Gray"><img
                                             src="{{ asset('frontend') }}/assets/images/products/product1-2.jpg"
                                             alt="product" width="625" height="808" /></span></li>
                                    <li class="swatch medium radius"><span class="swatchLbl" data-bs-toggle="tooltip"
                                          data-bs-placement="top" title="Orange"><img
                                             src="{{ asset('frontend') }}/assets/images/products/product1-3.jpg"
                                             alt="product" width="625" height="808" /></span></li>
                                 </ul>
                                 <!-- End Variant -->
                              </div>
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    ...
                                    <img class="blur-up lazyload"
                                       ...
                                       src="{{ asset('frontend') }}/assets/images/products/product2.jpg" alt="Product"
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    ...
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product3.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product3.jpg" alt="Product"
                                       title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product3-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product3-1.jpg"
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product4.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product4.jpg" alt="Product"
                                       title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product4-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product4-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product5.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product5.jpg" alt="Product"
                                       title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product5-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product5-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                              ...
                              <div class="product-details">
                                 ...
                                 <ul class="variants-clr swatches">
                                    ...
                                    <li class="swatch medium radius maroon"><span class="swatchLbl"
                                          data-bs-toggle="tooltip" data-bs-placement="top" title="maroon"></span></li>
                                 </ul>
                                 <!-- End Variant -->
                              </div>
                              <!-- End product details -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product6.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product6.jpg" alt="Product"
                                       title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product6-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product6-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product7.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product7.jpg" alt="Product"
                                       title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product7-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product7-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product8.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product8.jpg" alt="Product"
                                       title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product8-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product8-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                              ...
                              <div class="product-details">
                                 ...
                                 <ul class="variants-clr swatches">
                                    ...
                                    <li class="swatch medium radius navy"><span class="swatchLbl"
                                          data-bs-toggle="tooltip" data-bs-placement="top" title="navy"></span>
                                    </li>
                                    <li class="swatch medium radius darkgreen"><span class="swatchLbl"
                                          data-bs-toggle="tooltip" data-bs-placement="top" title="darkgreen"></span>
                                    </li>
                                 </ul>
                                 <!-- End Variant -->
                              </div>
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    ...
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product8.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product8.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product9.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product9.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product9-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product9-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product10.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product10.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product10-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product10-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product11.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product11.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product11-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product11-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product12.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product12.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product12-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product12-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product13.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product13.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product13-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product13-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product14.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product14.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product14-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product14-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product15.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product15.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product15-1.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product15-1.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Hover Image -->
                                 </a>
                                 <!-- End Product Image -->
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    ...
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product5.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product5.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                              ...
                              <div class="product-details">
                                 ...
                                 <ul class="variants-clr swatches">
                                    ...
                                    <li class="swatch medium radius maroon"><span class="swatchLbl"
                                          data-bs-toggle="tooltip" data-bs-placement="top" title="maroon"></span>
                                    </li>
                                 </ul>
                                 <!-- End Variant -->
                              </div>
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    ...
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product6.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product6.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                           ...
                           <div class="product-box">
                              ...
                              <div class="product-image">
                                 ...
                                 <a href="product-layout1.html" class="product-img rounded-3">
                                    ...
                                    <img class="primary blur-up lazyload"
                                       data-src="{{ asset('frontend') }}/assets/images/products/product7.jpg"
                                       src="{{ asset('frontend') }}/assets/images/products/product7.jpg"
                                       alt="Product" title="Product" width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
   ...
   <div class="section parallax-banner-style1 py-0">
      <div class="hero hero-large hero-overlay bg-size">
         <img class="bg-img" src="{{ asset('frontend') }}/assets/images/parallax/demo1-sale-banner.jpg"
            ...
            <div class="testimonial-slider-3items gp15 slick-arrow-dots arwOut5">
               <div class="testimonial-slide">
                  <div class="testimonial-content text-center">
                     <div class="quote-icon mb-3 mb-lg-4"><img class="blur-up lazyload mx-auto"
                           ...
                           src="{{ asset('frontend') }}/assets/images/icons/demo1-quote-icon.png" alt="icon"
                     ...
                     <div class="auhimg d-flex-justify-center text-left">
                        <div class="image"><img class="rounded-circle blur-up lazyload"
                              data-src="{{ asset('frontend') }}/assets/images/users/testimonial1-65x.jpg"
                              src="{{ asset('frontend') }}/assets/images/users/testimonial1-65x.jpg" alt="John Doe"
               ...
               <div class="testimonial-slide">
                  <div class="testimonial-content text-center">
                     ...
                     <div class="auhimg d-flex-justify-center text-left">
                        <div class="image"><img class="rounded-circle blur-up lazyload"
                              data-src="{{ asset('frontend') }}/assets/images/users/testimonial2-65x.jpg"
                              src="{{ asset('frontend') }}/assets/images/users/testimonial2-65x.jpg"
                              alt="Jessica Doe" width="65" height="65" /></div>
                        <div class="auhtext ms-3">
               ...
               <div class="testimonial-slide">
                  <div class="testimonial-content text-center">
                     ...
                     <div class="auhimg d-flex-justify-center text-left">
                        <div class="image"><img class="rounded-circle blur-up lazyload"
                              data-src="{{ asset('frontend') }}/assets/images/users/testimonial3-65x.jpg"
                              src="{{ asset('frontend') }}/assets/images/users/testimonial3-65x.jpg"
                              alt="Rick Edward" width="65" height="65" /></div>
                        <div class="auhtext ms-3">
               ...
               <div class="testimonial-slide rounded-3">
                  <div class="testimonial-content text-center">
                     ...
                     <div class="auhimg d-flex-justify-center text-left">
                        <div class="image"><img class="rounded-circle blur-up lazyload"
                              data-src="{{ asset('frontend') }}/assets/images/users/testimonial4-65x.jpg"
                              src="{{ asset('frontend') }}/assets/images/users/testimonial4-65x.jpg"
                              alt="Happy Buyer" width="65" height="65" /></div>
                        <div class="auhtext ms-3">
