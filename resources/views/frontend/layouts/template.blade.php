        ...
        <div class="page-wrapper">
            ...
            <div id="minicart-drawer" class="minicart-right-drawer offcanvas offcanvas-end" tabindex="-1">
                ...
                <div id="cartEmpty" class="cartEmpty d-flex-justify-center flex-column text-center p-3 text-muted d-none">
                    ...
                    <div class="cartEmpty-content mt-4">
                        ...
                        <a href="index-2.html" class="btn btn-primary cart-btn">Continue shopping</a>
                    </div>
                </div>
                <!--End MiniCart Empty-->
            ...
            {{-- <div class="product-notification mobile-hide" id="dismiss">
                ...
                <div class="media d-flex align-items-center">
                    <a href="product-layout1.html" class="mediaImg"><img class="w-100 h-100 blur-up lazyload" src="{{ asset('frontend') }}/assets/images/products/product2-120x170.jpg" data-src="{{ asset('frontend') }}/assets/images/products/product2-120x170.jpg" alt="Cuff Beanie Cap" width="120" height="170" /></a>
...
<!-- Mirrored from www.annimexweb.com/items/hema/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Sep 2023 19:40:51 GMT -->
</html>