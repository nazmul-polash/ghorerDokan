   ...
   <ul class="br-sideleft-menu">
      <li class="br-menu-item">
         <a href="{{ route('dashboard') }}"
            class="br-menu-link {{ Route::currentRouteNamed('dashboard') ? 'active' : ' ' }}">
      ...
      <li class="br-menu-item">
         ...
         <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{ route('category.index') }}"
                  class="sub-link {{ Route::currentRouteNamed('category.index') || Route::currentRouteNamed('category.create') ? 'active' : ' ' }}">Main
                  Category</a></li>
            <li class="sub-item"><a href="{{ route('sub_category.index') }}"
                  class="sub-link {{ Route::currentRouteNamed('sub_category.index') || Route::currentRouteNamed('sub_category.create') || Route::currentRouteNamed('sub_category.edit') ? 'active' : ' ' }}">Sub
                  Category</a></li>

            <li class="sub-item"><a href="{{ route('child_category.index') }}"
                  class="sub-link {{ Route::currentRouteNamed('child_category.index') || Route::currentRouteNamed('child_category.create') || Route::currentRouteNamed('child_category.edit') ? 'active' : ' ' }}">Child
                  Category</a></li>
         </ul>
      </li>
      ...
      <li class="br-menu-item">
         <a href="{{ route('brand.index') }}"
            class="br-menu-link {{ Route::currentRouteNamed('brand.index') ? 'active' : ' ' }}">
